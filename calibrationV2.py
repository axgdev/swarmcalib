...
class Calibrator:
    ...
    #Here we can put some default variables for deadzone, targetzone and pollingTime and PID parameters
        self.targetXController = finkenPID.PIDController(0.02, 0.001, 0.0001) #I set it to zero here for zero control
        self.targetYController = finkenPID.PIDController(0.02, 0.001, 0.0001)
